...
from etl.domain.entities import DataSalesEntity
...
class ETLTransformSpy(IMiddlewareTree):
    def __init__(self):
    ...
    def handle(self, contact: ContactsETLEntity, *args, **kwargs) -> ContactsETLEntity:
        ...
        progress = [
            ...
            InfoStagesEntity(**{"stage": "TRANSFORM", "status": "STARTED", "updated_at": "2023-03-20T11:20:36.453575"}),
            InfoStagesEntity(**{"stage": "TRANSFORM", "status": "FINISHED", "updated_at": "2023-03-20T11:20:41.634911"})
        ]

        data = test_data_raw_sales()
        data = [DataSalesEntity(*i) for i in data]
